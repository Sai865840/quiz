...
export const useSessionStore = create((set, get) => ({
    ...
    answerQuestion: (questionId, userAnswer, correctAnswer) => {
        ...
        const result = {
            ...
            userAnswer,
            userAnswerText: state.questions[state.currentIndex]?.options.find(o => o.label === userAnswer)?.text || '',
            correctAnswer,
            correctAnswerText: state.questions[state.currentIndex]?.options.find(o => o.label === correctAnswer)?.text || '',
            isCorrect,
    ...
    skipQuestion: (questionId) => {
        ...
        const result = {
            ...
            correctAnswerText: state.questions[state.currentIndex]?.options.find(o => o.label === (state.questions[state.currentIndex]?.correctOption || ''))?.text || '',
            isCorrect: false,
            timeSpent,
            confidence: null,
            flagged: false,
